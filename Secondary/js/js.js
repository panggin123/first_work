$(function(){
    ...
    $("#main_visual ul li").hide();
    $("#main_visual ul li").first().show();

    setInterval(function(){

        $("#main_visual ul").append( $("#main_visual ul li").first() );

        $("#main_visual ul li").last().hide();

        $("#main_visual ul li").first().fadeIn();
    ...
    $(function(){
        ...
        $("#image_slide1 ul li").hide();
        $("#image_slide1 ul li").first().show();
    
        setInterval(function(){
    
            $("#image_slide1 ul").append( $("#image_slide1 ul li").first() );
    
            $("#image_slide1 ul li").last().hide();
    
            $("#image_slide1 ul li").first().fadeIn();
    ...
    $(function(){
        ...
        $("#image_slide2 ul li").hide();
        $("#image_slide2 ul li").first().show();
    
        setInterval(function(){
    
            $("#image_slide2 ul").append( $("#image_slide2 ul li").first() );
    
            $("#image_slide2 ul li").last().hide();
    
            $("#image_slide2 ul li").first().fadeIn();
    ...
    $(function(){
        ...
        function prevAni() {
            ...
            $(".slide").animate({
                ...
                marginLeft : parseInt($(".slide").css("margin-left")) + carWidth
